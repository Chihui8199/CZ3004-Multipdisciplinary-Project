...
def stitch():
    ...
    cv2.imwrite('C:/Users/mdzak/Desktop/mdpFINAL/image_rec/result/result.png', combine) #CHANGE TO DIRECTORY WHERE STITCHED IMAGE IS SAVED
...
def numdetected():
    onlyfiles = next(os.walk('C:/Users/mdzak/Desktop/mdpFINAL/image_rec/runs/detect/exp'))[2] #directory of runs/detect/exp
    #print(len(onlyfiles))
