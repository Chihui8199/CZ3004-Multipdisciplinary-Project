            ...
            try:
                ...
                for message in message_list:
                    ...
                    if message[0] == ord(RobotToRpi.ROBOT_STOP):
                        ...
                        str = "".join(data)
                        str = str.encode()
                        self.message_queue.put_nowait(self._format_for(ALGORITHM_HEADER, str))
        ...
        while True:
            try:
                ...
                for message in message_list:
                    ...
                    if message[0] == ord(AlgorithmToRobot.SEND_COMMAND):
                        self.message_queue.put_nowait(self._format_for(ROBOT_HEADER, message[1:]))
            ...
            try:
                if not self.message_queue.empty():
                    ...
                    if target == ROBOT_HEADER:
                        ...
                        print("Successful write to Robot")
                        
                    elif target == ALGORITHM_HEADER:
                        self.algorithm.write(payload)
                        print("Successful write to Algo")
