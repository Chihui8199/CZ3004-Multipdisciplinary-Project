...
class MultiProcessComms:
    ...
    def __init__(self, image_processing_server_url: str=None):
        ...
        self.manager = Manager() # server process that handles communication among processes
        ...
        while True:
            try:
                if not self.image_queue.empty():
                    ...
                    # format of object in image_queue: [image, message]
                    # coordinates format: 'x,y|x,y|x,y'
