...
@torch.no_grad()
def runbullseye(weights=ROOT / 'bullseye.pt',  # model.pt path(s)
        #source=0,
...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'bullseye.pt', help='model path(s)')
