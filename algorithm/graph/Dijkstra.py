...
def printPath(parent, j, arr):
    ...
    if parent[j] == -1:
        ...
        arr.append(j)
        return
    printPath(parent, parent[j], arr)
    # print(j, end=" ")
    arr.append(j)

def printArr(dist, n, parent, dest):
    # print("Vertex\tDistance from source\tPath")
    arr = []
    i = int(dest)
    # for i in range(n):
    # print("\n%d\t\t%d \t\t\t\t\t" % (i, dist[i]), end=" ")
    printPath(parent, i, arr)
...
class Graph():
    ...
    def dijkstra(self, src, dest):
        ...
        arr = printArr(dist, V, parent, dest)
        return arr
